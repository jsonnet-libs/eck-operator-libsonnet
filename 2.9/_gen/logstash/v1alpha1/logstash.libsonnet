{
  ...
  '#':: d.pkg(name='logstash', url='', help='"Logstash is the Schema for the logstashes API"'),
  ...
  '#new':: d.fn(help='new returns an instance of Logstash', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'logstash.k8s.elastic.co/v1alpha1',
    kind: 'Logstash',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"LogstashSpec defines the desired state of Logstash"'),
  spec: {
    '#configRef':: d.obj(help='"ConfigRef contains a reference to an existing Kubernetes Secret holding the Logstash configuration. Logstash settings must be specified as yaml, under a single \\"logstash.yml\\" entry. At most one of [`Config`, `ConfigRef`] can be specified."'),
    configRef: {
    ...
    '#elasticsearchRefs':: d.obj(help='"ElasticsearchRefs are references to Elasticsearch clusters running in the same Kubernetes cluster."'),
    elasticsearchRefs: {
      '#withClusterName':: d.fn(help='"ClusterName is an alias for the cluster to be used to refer to the Elasticsearch cluster in Logstash configuration files, and will be used to identify \\"named clusters\\" in Logstash"', args=[d.arg(name='clusterName', type=d.T.string)]),
      withClusterName(clusterName): { clusterName: clusterName },
      '#withName':: d.fn(help='"Name of an existing Kubernetes object corresponding to an Elastic resource managed by ECK."', args=[d.arg(name='name', type=d.T.string)]),
      ...
      '#withSecretName':: d.fn(help='"SecretName is the name of an existing Kubernetes secret that contains connection information for associating an Elastic resource not managed by the operator. The referenced secret must contain the following: - `url`: the URL to reach the Elastic resource - `username`: the username of the user to be authenticated to the Elastic resource - `password`: the password of the user to be authenticated to the Elastic resource - `ca.crt`: the CA certificate in PEM format (optional). This field cannot be used in combination with the other fields name, namespace or serviceName."', args=[d.arg(name='secretName', type=d.T.string)]),
    ...
    '#monitoring':: d.obj(help='"Monitoring enables you to collect and ship log and monitoring data of this Logstash. Metricbeat and Filebeat are deployed in the same Pod as sidecars and each one sends data to one or two different Elasticsearch monitoring clusters running in the same Kubernetes cluster."'),
    monitoring: {
      '#logs':: d.obj(help='"Logs holds references to Elasticsearch clusters which receive log data from an associated resource."'),
      logs: {
      ...
      '#metrics':: d.obj(help='"Metrics holds references to Elasticsearch clusters which receive monitoring data from this resource."'),
      metrics: {
        '#elasticsearchRefs':: d.obj(help='"ElasticsearchRefs is a reference to a list of monitoring Elasticsearch clusters running in the same Kubernetes cluster. Due to existing limitations, only a single Elasticsearch cluster is currently supported."'),
        elasticsearchRefs: {
          '#withName':: d.fn(help='"Name of an existing Kubernetes object corresponding to an Elastic resource managed by ECK."', args=[d.arg(name='name', type=d.T.string)]),
    ...
    '#pipelinesRef':: d.obj(help='"PipelinesRef contains a reference to an existing Kubernetes Secret holding the Logstash Pipelines. Logstash pipelines must be specified as yaml, under a single \\"pipelines.yml\\" entry. At most one of [`Pipelines`, `PipelinesRef`] can be specified."'),
    pipelinesRef: {
      '#withSecretName':: d.fn(help='"SecretName is the name of the secret."', args=[d.arg(name='secretName', type=d.T.string)]),
      withSecretName(secretName): { spec+: { pipelinesRef+: { secretName: secretName } } },
    },
    '#secureSettings':: d.obj(help="\"SecureSettings is a list of references to Kubernetes Secrets containing sensitive configuration options for the Logstash. Secrets data can be then referenced in the Logstash config using the Secret's keys or as specified in `Entries` field of each SecureSetting.\""),
    secureSettings: {
    ...
    '#services':: d.obj(help='"Services contains details of services that Logstash should expose - similar to the HTTP layer configuration for the rest of the stack, but also applicable for more use cases than the metrics API, as logstash may need to be opened up for other services: Beats, TCP, UDP, etc, inputs."'),
    services: {
      ...
      service: {
        ...
        metadata: {
          ...
          withAnnotations(annotations): { service+: { metadata+: { annotations: annotations } } },
          '#withAnnotationsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
          withAnnotationsMixin(annotations): { service+: { metadata+: { annotations+: annotations } } },
          '#withFinalizers':: d.fn(help='', args=[d.arg(name='finalizers', type=d.T.array)]),
          withFinalizers(finalizers): { service+: { metadata+: { finalizers: if std.isArray(v=finalizers) then finalizers else [finalizers] } } },
          '#withFinalizersMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='finalizers', type=d.T.array)]),
          withFinalizersMixin(finalizers): { service+: { metadata+: { finalizers+: if std.isArray(v=finalizers) then finalizers else [finalizers] } } },
          '#withLabels':: d.fn(help='', args=[d.arg(name='labels', type=d.T.object)]),
          withLabels(labels): { service+: { metadata+: { labels: labels } } },
          '#withLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
          withLabelsMixin(labels): { service+: { metadata+: { labels+: labels } } },
          '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { service+: { metadata+: { name: name } } },
          '#withNamespace':: d.fn(help='', args=[d.arg(name='namespace', type=d.T.string)]),
          withNamespace(namespace): { service+: { metadata+: { namespace: namespace } } },
        },
        ...
        spec: {
          ...
          ports: {
            '#withAppProtocol':: d.fn(help='"The application protocol for this port. This field follows standard Kubernetes label syntax. Un-prefixed names are reserved for IANA standard service names (as per RFC-6335 and https://www.iana.org/assignments/service-names). Non-standard protocols should use prefixed names such as mycompany.com/my-custom-protocol."', args=[d.arg(name='appProtocol', type=d.T.string)]),
          ...
          sessionAffinityConfig: {
            ...
            clientIP: {
              ...
              withTimeoutSeconds(timeoutSeconds): { service+: { spec+: { sessionAffinityConfig+: { clientIP+: { timeoutSeconds: timeoutSeconds } } } } },
            },
          },
          ...
          withAllocateLoadBalancerNodePorts(allocateLoadBalancerNodePorts): { service+: { spec+: { allocateLoadBalancerNodePorts: allocateLoadBalancerNodePorts } } },
          ...
          withClusterIP(clusterIP): { service+: { spec+: { clusterIP: clusterIP } } },
          ...
          withClusterIPs(clusterIPs): { service+: { spec+: { clusterIPs: if std.isArray(v=clusterIPs) then clusterIPs else [clusterIPs] } } },
          ...
          withClusterIPsMixin(clusterIPs): { service+: { spec+: { clusterIPs+: if std.isArray(v=clusterIPs) then clusterIPs else [clusterIPs] } } },
          ...
          withExternalIPs(externalIPs): { service+: { spec+: { externalIPs: if std.isArray(v=externalIPs) then externalIPs else [externalIPs] } } },
          ...
          withExternalIPsMixin(externalIPs): { service+: { spec+: { externalIPs+: if std.isArray(v=externalIPs) then externalIPs else [externalIPs] } } },
          ...
          withExternalName(externalName): { service+: { spec+: { externalName: externalName } } },
          ...
          withExternalTrafficPolicy(externalTrafficPolicy): { service+: { spec+: { externalTrafficPolicy: externalTrafficPolicy } } },
          ...
          withHealthCheckNodePort(healthCheckNodePort): { service+: { spec+: { healthCheckNodePort: healthCheckNodePort } } },
          ...
          withInternalTrafficPolicy(internalTrafficPolicy): { service+: { spec+: { internalTrafficPolicy: internalTrafficPolicy } } },
          ...
          withIpFamilies(ipFamilies): { service+: { spec+: { ipFamilies: if std.isArray(v=ipFamilies) then ipFamilies else [ipFamilies] } } },
          ...
          withIpFamiliesMixin(ipFamilies): { service+: { spec+: { ipFamilies+: if std.isArray(v=ipFamilies) then ipFamilies else [ipFamilies] } } },
          ...
          withIpFamilyPolicy(ipFamilyPolicy): { service+: { spec+: { ipFamilyPolicy: ipFamilyPolicy } } },
          ...
          withLoadBalancerClass(loadBalancerClass): { service+: { spec+: { loadBalancerClass: loadBalancerClass } } },
          '#withLoadBalancerIP':: d.fn(help='"Only applies to Service Type: LoadBalancer. This feature depends on whether the underlying cloud-provider supports specifying the loadBalancerIP when a load balancer is created. This field will be ignored if the cloud-provider does not support the feature. Deprecated: This field was under-specified and its meaning varies across implementations, and it cannot support dual-stack. As of Kubernetes v1.24, users are encouraged to use implementation-specific annotations when available. This field may be removed in a future API version."', args=[d.arg(name='loadBalancerIP', type=d.T.string)]),
          withLoadBalancerIP(loadBalancerIP): { service+: { spec+: { loadBalancerIP: loadBalancerIP } } },
          ...
          withLoadBalancerSourceRanges(loadBalancerSourceRanges): { service+: { spec+: { loadBalancerSourceRanges: if std.isArray(v=loadBalancerSourceRanges) then loadBalancerSourceRanges else [loadBalancerSourceRanges] } } },
          ...
          withLoadBalancerSourceRangesMixin(loadBalancerSourceRanges): { service+: { spec+: { loadBalancerSourceRanges+: if std.isArray(v=loadBalancerSourceRanges) then loadBalancerSourceRanges else [loadBalancerSourceRanges] } } },
          ...
          withPorts(ports): { service+: { spec+: { ports: if std.isArray(v=ports) then ports else [ports] } } },
          ...
          withPortsMixin(ports): { service+: { spec+: { ports+: if std.isArray(v=ports) then ports else [ports] } } },
          ...
          withPublishNotReadyAddresses(publishNotReadyAddresses): { service+: { spec+: { publishNotReadyAddresses: publishNotReadyAddresses } } },
          ...
          withSelector(selector): { service+: { spec+: { selector: selector } } },
          ...
          withSelectorMixin(selector): { service+: { spec+: { selector+: selector } } },
          ...
          withSessionAffinity(sessionAffinity): { service+: { spec+: { sessionAffinity: sessionAffinity } } },
          ...
          withType(type): { service+: { spec+: { type: type } } },
        },
      },
      ...
      tls: {
        ...
        certificate: {
          '#withSecretName':: d.fn(help='"SecretName is the name of the secret."', args=[d.arg(name='secretName', type=d.T.string)]),
          withSecretName(secretName): { tls+: { certificate+: { secretName: secretName } } },
        },
        ...
        selfSignedCertificate: {
          ...
          withDisabled(disabled): { tls+: { selfSignedCertificate+: { disabled: disabled } } },
          ...
          withSubjectAltNames(subjectAltNames): { tls+: { selfSignedCertificate+: { subjectAltNames: if std.isArray(v=subjectAltNames) then subjectAltNames else [subjectAltNames] } } },
          ...
          withSubjectAltNamesMixin(subjectAltNames): { tls+: { selfSignedCertificate+: { subjectAltNames+: if std.isArray(v=subjectAltNames) then subjectAltNames else [subjectAltNames] } } },
        },
      },
      '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { name: name },
    ...
    '#withConfig':: d.fn(help='"Config holds the Logstash configuration. At most one of [`Config`, `ConfigRef`] can be specified."', args=[d.arg(name='config', type=d.T.object)]),
    withConfig(config): { spec+: { config: config } },
    '#withConfigMixin':: d.fn(help='"Config holds the Logstash configuration. At most one of [`Config`, `ConfigRef`] can be specified."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='config', type=d.T.object)]),
    withConfigMixin(config): { spec+: { config+: config } },
    '#withCount':: d.fn(help='', args=[d.arg(name='count', type=d.T.integer)]),
    withCount(count): { spec+: { count: count } },
    '#withElasticsearchRefs':: d.fn(help='"ElasticsearchRefs are references to Elasticsearch clusters running in the same Kubernetes cluster."', args=[d.arg(name='elasticsearchRefs', type=d.T.array)]),
    ...
    '#withElasticsearchRefsMixin':: d.fn(help='"ElasticsearchRefs are references to Elasticsearch clusters running in the same Kubernetes cluster."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='elasticsearchRefs', type=d.T.array)]),
    ...
    '#withImage':: d.fn(help='"Image is the Logstash Docker image to deploy. Version and Type have to match the Logstash in the image."', args=[d.arg(name='image', type=d.T.string)]),
    withImage(image): { spec+: { image: image } },
    '#withPipelines':: d.fn(help='"Pipelines holds the Logstash Pipelines. At most one of [`Pipelines`, `PipelinesRef`] can be specified."', args=[d.arg(name='pipelines', type=d.T.array)]),
    withPipelines(pipelines): { spec+: { pipelines: if std.isArray(v=pipelines) then pipelines else [pipelines] } },
    '#withPipelinesMixin':: d.fn(help='"Pipelines holds the Logstash Pipelines. At most one of [`Pipelines`, `PipelinesRef`] can be specified."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='pipelines', type=d.T.array)]),
    withPipelinesMixin(pipelines): { spec+: { pipelines+: if std.isArray(v=pipelines) then pipelines else [pipelines] } },
    '#withPodTemplate':: d.fn(help='"PodTemplate provides customisation options for the Logstash pods."', args=[d.arg(name='podTemplate', type=d.T.object)]),
    withPodTemplate(podTemplate): { spec+: { podTemplate: podTemplate } },
    '#withPodTemplateMixin':: d.fn(help='"PodTemplate provides customisation options for the Logstash pods."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='podTemplate', type=d.T.object)]),
    withPodTemplateMixin(podTemplate): { spec+: { podTemplate+: podTemplate } },
    '#withRevisionHistoryLimit':: d.fn(help='"RevisionHistoryLimit is the number of revisions to retain to allow rollback in the underlying StatefulSet."', args=[d.arg(name='revisionHistoryLimit', type=d.T.integer)]),
    ...
    '#withSecureSettingsMixin':: d.fn(help="\"SecureSettings is a list of references to Kubernetes Secrets containing sensitive configuration options for the Logstash. Secrets data can be then referenced in the Logstash config using the Secret's keys or as specified in `Entries` field of each SecureSetting.\"\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='secureSettings', type=d.T.array)]),
    ...
    '#withServices':: d.fn(help='"Services contains details of services that Logstash should expose - similar to the HTTP layer configuration for the rest of the stack, but also applicable for more use cases than the metrics API, as logstash may need to be opened up for other services: Beats, TCP, UDP, etc, inputs."', args=[d.arg(name='services', type=d.T.array)]),
    withServices(services): { spec+: { services: if std.isArray(v=services) then services else [services] } },
    '#withServicesMixin':: d.fn(help='"Services contains details of services that Logstash should expose - similar to the HTTP layer configuration for the rest of the stack, but also applicable for more use cases than the metrics API, as logstash may need to be opened up for other services: Beats, TCP, UDP, etc, inputs."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='services', type=d.T.array)]),
    withServicesMixin(services): { spec+: { services+: if std.isArray(v=services) then services else [services] } },
    '#withVersion':: d.fn(help='"Version of the Logstash."', args=[d.arg(name='version', type=d.T.string)]),
